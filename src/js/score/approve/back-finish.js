...
(function ($, window, document, undefined) {
    var uploadMapping = {
        "/api/score/approve/renshePrevApprove/backFinish": "backFinish"
    };
    ...
    App.backFinish = {
        page: function (title) {
            ...
            scoreRenshePrevApprove("backFinish");
        }
    };
                        ...
                        actionColumns: [
                            {
                                ...
                                handle: function (index, d) {
                                    bootbox.confirm("确定该操作？", function (result) {
                                        if (result){
                                            var requestUrl = App.href + "/api/score/approve/renshePrevApprove/backFinish2?id=" + d.id;
                                            $.ajax({
                                                type: "POST",
                                                dataType: "json",
                                                url: requestUrl,

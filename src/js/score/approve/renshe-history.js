...
(function ($, window, document, undefined) {
    var uploadMapping = {
        ...
        "/api/score/approve/rensheAccept/history": "scoreRensheAcceptd" //  用已审核通过的页面来替代历史数据
    };
                        ...
                        actionColumns: [
                            {
                                ...
                                cls: "btn-info btn-sm",
                                handle: function (index, d) {
                                    var requestUrl = App.href + "/api/score/print/approveEmptyDoc?identityInfoId=" + d.id;
                                    $.ajax({
                                        type: "GET",
                                        dataType: "json",
                                        url: requestUrl,
                                                ...
                                                buttons: [
                                                    {
                                                        ...
                                                        cls: 'btn btn-primary',
                                                        handle: function (m) {
                                                            window.open(App.href + "/api/score/export/approveEmptyDoc?identityInfoId=" + d.id)
                                                        }
                                                    }
                                                ],
                                                onEnter: function (m) {

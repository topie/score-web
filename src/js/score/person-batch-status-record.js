...
(function ($, window, document, undefined) {
    var uploadMapping = {
        "/api/score/personBatchStatusRecord/list": "scorePersonBatchStatusRecord"
    };
    App.requestMapping = $.extend({}, window.App.requestMapping, uploadMapping);
    App.scorePersonBatchStatusRecord = {
        page: function (title) {
        ...
        $.ajax({
            ...
            success: function (fd) {
                if (fd.code === 200) {
                    ...
                    var grid;
                    var options = {
                        url: App.href + "/api/score/personBatchStatusRecord/list",

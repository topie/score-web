...
(function ($, window, document, undefined) {
    ...
    var initEvents = function () {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: App.href + "/api/core/dict/formItems",
            success: function (fd) {
                if (fd.code === 200) {
                    ...
                    var grid;
                    var options = {
                        url: App.href + "/api/core/dict/list",
                        contentType: "table",
                        ...
                        actionColumns: [{
                            ...
                            handle: function (index, d) {
                                ...
                                var form = modal.$body.orangeForm({
                                    ...
                                    name: "edit_form",
                                    method: "POST",
                                    action: App.href + "/api/core/dict/update",
                                    ajaxSubmit: true,
                                ...
                                form.loadRemote(App.href + "/api/core/dict/detail?id=" + d.id);
                            }
                        }, {
                            text: "删除",
                            ...
                            handle: function (index, data) {
                                bootbox.confirm("确定该操作?", function (result) {
                                    if (result) {
                                        var requestUrl = App.href + "/api/core/dict/delete";
                                        $.ajax({
                                            type: "POST",
                                            dataType: "json",
                                            data: {
